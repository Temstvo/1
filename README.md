> Текущий путь запуска: [платный пилот — один сервер и один тариф](docs/PILOT.md).
> Production Compose и команды в этой инструкции заменяют прежние примеры развёртывания ниже.
> Реальные оплата, доставка почты и VPN-туннель требуют проверки на инфраструктуре оператора.
