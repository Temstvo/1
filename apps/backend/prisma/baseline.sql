...
-- CreateEnum
CREATE TYPE "SecurityEventType" AS ENUM ('USER_CREATED', 'LOGIN_SUCCESS', 'LOGIN_FAILURE', 'PASSWORD_CHANGED', 'PASSWORD_RESET', 'EMAIL_VERIFIED', 'TWO_FA_ENABLED', 'TWO_FA_DISABLED', 'SUSPICIOUS_ACTIVITY', 'BRUTE_FORCE_DETECTED', 'TOKEN_REFRESH', 'SESSION_REVOKED');
...
CREATE TABLE "free_vpn_configs" (
    ...
    CONSTRAINT "free_vpn_configs_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "sub_links" (
    ...
    CONSTRAINT "sub_links_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "free_vpn_configs_protocol_idx" ON "free_vpn_configs"("protocol");

-- CreateIndex
CREATE INDEX "free_vpn_configs_country_idx" ON "free_vpn_configs"("country");

-- CreateIndex
CREATE INDEX "free_vpn_configs_list_type_idx" ON "free_vpn_configs"("list_type");

-- CreateIndex
CREATE INDEX "free_vpn_configs_is_active_idx" ON "free_vpn_configs"("is_active");
...
-- CreateIndex
CREATE UNIQUE INDEX "sub_links_token_key" ON "sub_links"("token");

-- CreateIndex
CREATE INDEX "sub_links_telegram_id_idx" ON "sub_links"("telegram_id");

-- CreateIndex
CREATE INDEX "sub_links_token_idx" ON "sub_links"("token");
