  ...
  return (
    <div>
      <div className="mb-8 text-center lg:text-left">
        ...
        <p className="mt-2 text-gray-400">Sign in to your APPI VPN account</p>
      </div>
      <form className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" className="w-4 h-4 rounded border-gray-600 bg-[#111] text-purple-500 focus:ring-purple-500/20" />
      ...
      <div className="mt-6 relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-[#000] px-4 text-gray-500">or continue with</span>
        </div>
      </div>
      <div className="mt-6 grid grid-cols-2 gap-3">
        <button className="flex items-center justify-center gap-2 rounded-xl border border-gray-700/50 bg-[#111] px-4 py-3 text-sm font-medium text-gray-300 hover:bg-[#222] hover:border-gray-600 transition-all">
