...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-8">
      <h1 className="text-2xl font-bold text-[hsl(var(--foreground))]">{t('settings_title')}</h1>
        ...
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-xl overflow-hidden">
          <div className="happ-settings-row">
            ...
            <select
              ...
              className="bg-[hsl(var(--muted))] border border-[hsl(var(--border))] rounded-lg px-3 py-2.5 text-sm text-[hsl(var(--foreground))] focus:outline-none focus:border-[hsl(var(--primary))]"
            >
          ...
          <button className="happ-settings-row w-full text-left hover:bg-[hsl(var(--muted))]/50 transition-colors">
        ...
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-xl overflow-hidden">
          ...
          <div className="happ-settings-row">
            ...
            <button
              ...
              className={`happ-toggle h-6 w-11 ${fragmentation ? 'bg-[hsl(var(--primary))]' : 'bg-[hsl(var(--muted))]'}`}
            >
          ...
          <div className="happ-settings-row">
            ...
            <button
              ...
              className={`happ-toggle h-6 w-11 ${multiplexor ? 'bg-[hsl(var(--primary))]' : 'bg-[hsl(var(--muted))]'}`}
            >
        ...
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-xl overflow-hidden">
          ...
          <div className="happ-settings-row">
            ...
            <button
              ...
              className={`happ-toggle h-6 w-11 ${lanAccess ? 'bg-[hsl(var(--primary))]' : 'bg-[hsl(var(--muted))]'}`}
            >
