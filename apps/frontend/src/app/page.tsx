        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { icon: <svg className="w-10 h-10" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C9.5 2 7.5 4 7.5 6.5V8c-1.5.5-2.5 1.5-3 3-.3 1 0 2 .5 2.5.3.3.3.7.2 1.1-.2.5-.5 1-.5 1.5 0 .8.5 1.5 1.2 1.8.5.2.7.7.5 1.2-.3.8.2 1.5 1 1.8h8.6c.8-.3 1.3-1 1-1.8-.2-.5 0-1 .5-1.2.7-.3 1.2-1 1.2-1.8 0-.5-.3-1-.5-1.5-.1-.4-.1-.8.2-1.1.5-.5.8-1.5.5-2.5-.5-1.5-1.5-2.5-3-3V6.5C16.5 4 14.5 2 12 2zm0 2c1.4 0 2.5 1.1 2.5 2.5V7h-5V6.5C9.5 5.1 10.6 4 12 4zm-3 6h6c.3 0 .5.2.5.5s-.2.5-.5.5h-6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zm1 2h4c.3 0 .5.2.5.5s-.2.5-.5.5h-4c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zm1.5 3c-.4 0-.8.4-.8.8s.4.8.8.8.8-.4.8-.8-.4-.8-.8-.8zm3 0c-.4 0-.8.4-.8.8s.4.8.8.8.8-.4.8-.8-.4-.8-.8-.8z" /></svg>, name: 'Linux', note: 'Ubuntu, Debian, CentOS', href: '#', primary: true },
            ].map((p, i) => (
