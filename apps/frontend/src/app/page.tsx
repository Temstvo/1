...
const PLANS = {
  month: [
    ...
    },
    {
      ...
      features: [
        'Всё из «Продвинутого»',
        'Управление членами через Telegram',
        'Family-режим, раздельные подключения',
      ],
    },
  ],
  year: [
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="pt-40 pb-16 md:pb-20 px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-9 max-w-xl mx-auto">
            VPN-сервис для тех, кто ценит честные цифры и тихую работу. Скорость до 1&nbsp;Гбит/с,
            305&nbsp;серверов в 7&nbsp;странах.
          </p>
          <div>
            ...
            <div className="mt-4">
              <a
                href="#how"
                className="text-sm text-gray-500 hover:text-white transition-colors underline underline-offset-4 decoration-gray-700"
              >
                Как это работает
              </a>
            </div>
            ...
            {[...CITIES, ...CITIES].map((city, i) => (
              <span key={i} className="flex items-center text-sm text-gray-600">
                ...
                <svg className="w-3 h-3 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2l2.9 6.9L22 12l-7.1 3.1L12 22l-2.9-6.9L2 12l7.1-3.1L12 2z" />
                </svg>
              </span>
            ))}
          </div>
      ...
      <section className="py-20 md:py-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-3 items-stretch">
            <div className="card p-6 flex flex-col items-center justify-center text-center min-h-[140px]">
              <div className="text-sm text-gray-400">Ваше устройство</div>
              <div className="mt-2 text-xs text-gray-600">DPI · блокировки</div>
            </div>
            <div className="border border-purple-500/30 bg-[#171420] rounded-2xl p-6 flex flex-col items-center justify-center text-center min-h-[140px]">
              <svg
      ...
      {/* ===== FEATURES ===== */}
      <section id="features" className="py-20 md:py-24 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              Что делает APPI другим, чем остальные.
            </h2>
            <p className="text-gray-400 mt-4 max-w-xl mx-auto">
              Меньше серверов, больше пропускной способности. Цифры — настоящие, замерены iperf3.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="card p-8">
              ...
              <p className="text-sm text-gray-500">
                P95 за последние 30 суток (iperf3). Каждый сервер — собственный 1 Гбит/с канал.
              </p>
            </div>
            ...
            <div className="card p-8">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Германия, Нидерланды, Россия, Финляндия, Польша, США, Турция. Маршрут — по
            ...
            <div className="card p-8">
              ...
              <pre className="bg-[#0a0a0a] border border-white/10 rounded-xl p-4 text-xs text-green-400 font-mono leading-relaxed overflow-x-auto">{`tls       = 1.3
cipher    = chacha20_poly1305
log_to    = /dev/null`}</pre>
              <p className="text-sm text-gray-500 mt-4">
                Современные шифры TLS 1.3 (ChaCha20-Poly1305, AES-128-GCM). Логи пишутся в /dev/null
                — данных физически нет.
              </p>
            </div>
            ...
            <div className="card p-8">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center justify-between px-4 py-3 border border-white/10 rounded-xl text-sm">
          ...
          <div className="mt-4 card p-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {['Карта', 'СБП ₽', 'USDT BSC', 'USDT TON', 'USDT TRON'].map((m) => (
                <span key={m} className="chip text-gray-300">
                  {m}
                </span>
              ))}
            </div>
            <p className="text-sm text-gray-500 mt-4">
              Карты (Visa / Mastercard / МИР), СБП без комиссии или USDT в трёх сетях.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 mt-4">
              От первой оплаты до защищённого соединения — меньше времени, чем уходит на кофе.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Личный, Продвинутый или Семья. Можно начать с трёхдневного триала за 10 ₽ — отменить можно в любой момент.',
              },
              {
                num: '2',
                title: 'Установите приложение',
                desc: 'Готовые сборки под iOS, Android, Windows, macOS и Linux. QR-код подключения — на экране.',
              },
              {
                num: '3',
                title: 'Подключитесь',
                desc: 'Один тап. Шифрование включается до того, как первый пакет покинет устройство.',
              },
            ].map((s, i) => (
      ...
      <section className="py-16 px-4 md:px-6">
        <div className="max-w-3xl mx-auto border border-purple-500/30 bg-[#171420] rounded-3xl p-8 md:p-12 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-3">
            3 дня за 10 ₽, потом автопродление по тарифу — отменить можно в любой момент.
          </h2>
          <ul className="space-y-2.5 my-6 text-left max-w-md mx-auto">
            {[
              'Полная скорость до 1 Гбит/с — без ограничений',
              'Все 305 серверов в 7 странах доступны сразу',
              'Возврат денег в течение 7 дней без вопросов',
            ].map((f) => (
      ...
      {/* ===== PRICING ===== */}
      <section id="pricing" className="py-20 md:py-24 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              Без скрытых платежей, отмена в один клик.
            </h2>
            <p className="text-gray-400 mt-4">
              Платите за месяц или год. В течение семи дней можно вернуть деньги — без вопросов.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mb-10">
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm transition-colors ${billing === 'month' ? 'bg-white text-black font-semibold' : 'text-gray-400 hover:text-white'}`}
            >
              Месяц
            </button>
            <button
              onClick={() => setBilling('year')}
              className={`px-5 py-2 rounded-full text-sm transition-colors ${billing === 'year' ? 'bg-white text-black font-semibold' : 'text-gray-400 hover:text-white'}`}
            >
              Год <span className="text-green-400 font-semibold ml-1">−20%</span>
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {PLANS[billing].map((plan, i) => (
              <div
                key={plan.name}
                className={`relative rounded-2xl p-8 border ${plan.popular ? 'border-purple-500/40 bg-[#171420]' : 'border-white/10 bg-[#141416]'}`}
              >
                {plan.popular && (
                ...
                <div className="text-xs text-gray-500 mt-2 mb-5">
                  {plan.deviceCount} устройства · {billing === 'month' ? '30' : '365'} дней
                </div>
                ...
                <Link
                  href="/register"
                  className={`block text-center py-3 rounded-full font-semibold text-sm transition-colors ${plan.popular ? 'btn-primary' : 'btn-outline'}`}
                >
          ...
          <div className="text-center text-sm text-gray-500 mt-8">
            <div className="mb-1">
              <span className="text-green-400 font-semibold">Возврат: 7 дней без вопросов</span>
            </div>
      ...
      {/* ===== FAQ ===== */}
      <section id="faq" className="py-20 md:py-24 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {FAQS.map((faq, i) => (
              <div
                key={i}
                className={`card overflow-hidden ${activeFaq === i ? 'border-purple-500/30' : ''}`}
              >
                <button
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 text-gray-500 shrink-0 transition-transform ${activeFaq === i ? 'rotate-180' : ''}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
                    stroke="currentColor"
      ...
      {/* ===== FINAL CTA ===== */}
      <section className="py-24 md:py-28 px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-10 text-sm">
              <div>
                ...
                <div className="space-y-2">
                  <a
                    href="mailto:support@appivpn.com"
              ...
              <div>
                ...
                <div className="space-y-2 text-gray-400">
                  <a
                    href="mailto:support@appivpn.ru"
                    className="block hover:text-white transition-colors"
                  >
                    support@appivpn.ru
                  </a>
                  <a
                    href="https://t.me/appivpn"
                    className="block hover:text-white transition-colors"
                  >
                    Telegram
                  </a>
