        ...
        <div className="space-y-8 text-gray-300 leading-relaxed text-sm md:text-base">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Если одобрят — деньги вернутся на ту же карту за 3–5 рабочих дней (иногда до 10 —
          ...
          <section>
            ...
            <p>
              Возврат не производится после семи дней с момента оплаты, а также за пробный период (3
              дня за 10 ₽) после его полного использования.
            </p>
          </section>

          <div className="bg-[#111] border border-white/5 rounded-2xl p-6">
            <p className="text-sm text-gray-400">
              Не нужно идти в банк или оспаривать платёж — все вопросы решаем мы. Поддержка отвечает
              в течение часа.
            </p>
          </div>
        </div>
